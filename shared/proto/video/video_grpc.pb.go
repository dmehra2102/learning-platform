...
const (
	...
	VideoService_GetVideoStream_FullMethodName           = "/video.VideoService/GetVideoStream"
	...
	VideoService_GetVideoProcessingStatus_FullMethodName = "/video.VideoService/GetVideoProcessingStatus"
)
...
type VideoServiceClient interface {
	...
	GetVideoStream(ctx context.Context, in *GetVideoStreamUrlRequest, opts ...grpc.CallOption) (*VideoStreamUrlResponse, error)
	DeleteVideo(ctx context.Context, in *DeleteVideoRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	UpdateVideoMetadata(ctx context.Context, in *UpdateVideoMetadataRequest, opts ...grpc.CallOption) (*VideoResponse, error)
	GetVideosByIds(ctx context.Context, in *GetVideosByIdsRequest, opts ...grpc.CallOption) (*GetVideosByIdsResponse, error)
	GetVideoProcessingStatus(ctx context.Context, in *GetVideoProcessingStatusRequest, opts ...grpc.CallOption) (*VideoProcessingStatusResponse, error)
}
...
func (c *videoServiceClient) GetVideoStream(ctx context.Context, in *GetVideoStreamUrlRequest, opts ...grpc.CallOption) (*VideoStreamUrlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VideoStreamUrlResponse)
	err := c.cc.Invoke(ctx, VideoService_GetVideoStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoServiceClient) UpdateVideoMetadata(ctx context.Context, in *UpdateVideoMetadataRequest, opts ...grpc.CallOption) (*VideoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VideoResponse)
...
func (c *videoServiceClient) GetVideoProcessingStatus(ctx context.Context, in *GetVideoProcessingStatusRequest, opts ...grpc.CallOption) (*VideoProcessingStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VideoProcessingStatusResponse)
	err := c.cc.Invoke(ctx, VideoService_GetVideoProcessingStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VideoServiceServer interface {
	...
	GetVideoStream(context.Context, *GetVideoStreamUrlRequest) (*VideoStreamUrlResponse, error)
	DeleteVideo(context.Context, *DeleteVideoRequest) (*emptypb.Empty, error)
	UpdateVideoMetadata(context.Context, *UpdateVideoMetadataRequest) (*VideoResponse, error)
	GetVideosByIds(context.Context, *GetVideosByIdsRequest) (*GetVideosByIdsResponse, error)
	GetVideoProcessingStatus(context.Context, *GetVideoProcessingStatusRequest) (*VideoProcessingStatusResponse, error)
...
func (UnimplementedVideoServiceServer) GetVideoStream(context.Context, *GetVideoStreamUrlRequest) (*VideoStreamUrlResponse, error) {
...
func (UnimplementedVideoServiceServer) UpdateVideoMetadata(context.Context, *UpdateVideoMetadataRequest) (*VideoResponse, error) {
...
func (UnimplementedVideoServiceServer) GetVideoProcessingStatus(context.Context, *GetVideoProcessingStatusRequest) (*VideoProcessingStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVideoProcessingStatus not implemented")
}
...
func _VideoService_GetVideoStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVideoStreamUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoServiceServer).GetVideoStream(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VideoService_GetVideoStream_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).GetVideoStream(ctx, req.(*GetVideoStreamUrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VideoService_GetVideoProcessingStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVideoProcessingStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoServiceServer).GetVideoProcessingStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VideoService_GetVideoProcessingStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).GetVideoProcessingStatus(ctx, req.(*GetVideoProcessingStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VideoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVideoProcessingStatus",
			Handler:    _VideoService_GetVideoProcessingStatus_Handler,
		},
	},
